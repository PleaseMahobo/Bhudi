using MyRepository = Bhudi.Administration.Repositories.UserPermissionRepository;
using MyRow = Bhudi.Administration.UserPermissionRow;

namespace Bhudi.Administration.Endpoints;
